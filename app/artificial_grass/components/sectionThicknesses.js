            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-3 lg:p-6 bg-[#C39533] flex flex-col justify-center">
               ...
               <div className="grid grid-cols-1 gap-3 lg:gap-4">
                  ...
                  <button
                    className="p-2 lg:p-3 bg-[#623183] rounded-lg lg:rounded-xl shadow-md active:shadow-none cursor-pointer transition hover:scale-101 active:scale-99"
                    onClick={() => handleIOSAR('/models/artificial_grass/15mm.usdz')}
                  >
                    <div className="flex items-center justify-center gap-2 lg:gap-4">
                      <TbAugmentedReality2 className="text-xl lg:text-2xl text-[#FFFFFF]" />
                      <h1 className="font-bold tracking-tight text-md lg:text-lg text-[#FFFFFF]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-3 lg:p-6 bg-[#C39533] flex flex-col justify-center">
               ...
               <div className="grid grid-cols-1 gap-3 lg:gap-4">
                  ...
                  <button
                    className="p-2 lg:p-3 bg-[#623183] rounded-lg lg:rounded-xl shadow-md active:shadow-none cursor-pointer transition hover:scale-101 active:scale-99"
                    onClick={() => handleIOSAR('/models/artificial_grass/25mm.usdz')}
                  >
                    <div className="flex items-center justify-center gap-2 lg:gap-4">
                      <TbAugmentedReality2 className="text-xl lg:text-2xl text-[#FFFFFF]" />
                      <h1 className="font-bold tracking-tight text-md lg:text-lg text-[#FFFFFF]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-3 lg:p-6 bg-[#C39533] flex flex-col justify-center">
               ...
               <div className="grid grid-cols-1 gap-3 lg:gap-4">
                  ...
                  <button
                    className="p-2 lg:p-3 bg-[#623183] rounded-lg lg:rounded-xl shadow-md active:shadow-none cursor-pointer transition hover:scale-101 active:scale-99"
                    onClick={() => handleIOSAR('/models/artificial_grass/30mm.usdz')}
                  >
                    <div className="flex items-center justify-center gap-2 lg:gap-4">
                      <TbAugmentedReality2 className="text-xl lg:text-2xl text-[#FFFFFF]" />
                      <h1 className="font-bold tracking-tight text-md lg:text-lg text-[#FFFFFF]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-3 lg:p-6 bg-[#C39533] flex flex-col justify-center">
               ...
               <div className="grid grid-cols-1 gap-3 lg:gap-4">
                  ...
                  <button
                    className="p-2 lg:p-3 bg-[#623183] rounded-lg lg:rounded-xl shadow-md active:shadow-none cursor-pointer transition hover:scale-101 active:scale-99"
                    onClick={() => handleIOSAR('/models/artificial_grass/35mm.usdz')}
                  >
                    <div className="flex items-center justify-center gap-2 lg:gap-4">
                      <TbAugmentedReality2 className="text-xl lg:text-2xl text-[#FFFFFF]" />
                      <h1 className="font-bold tracking-tight text-md lg:text-lg text-[#FFFFFF]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-3 lg:p-6 bg-[#C39533] flex flex-col justify-center">
               ...
               <div className="grid grid-cols-1 gap-3 lg:gap-4">
                  ...
                  <button
                    className="p-2 lg:p-3 bg-[#623183] rounded-lg lg:rounded-xl shadow-md active:shadow-none cursor-pointer transition hover:scale-101 active:scale-99"
                    onClick={() => handleIOSAR('/models/artificial_grass/40mm.usdz')}
                  >
                    <div className="flex items-center justify-center gap-2 lg:gap-4">
                      <TbAugmentedReality2 className="text-xl lg:text-2xl text-[#FFFFFF]" />
                      <h1 className="font-bold tracking-tight text-md lg:text-lg text-[#FFFFFF]">
