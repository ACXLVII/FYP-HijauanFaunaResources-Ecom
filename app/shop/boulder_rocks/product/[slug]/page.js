...
import Heading from '@/app/shop/boulder_rocks/product/[slug]/components/sectionHeading'
import Content from '@/app/shop/boulder_rocks/product/[slug]/components/sectionContent'
...
export default async function ProductPage({ params }) {
  ...
  const res = await fetch(`${protocol}://${host}/api/boulder_rocks/${slug}`, { 
