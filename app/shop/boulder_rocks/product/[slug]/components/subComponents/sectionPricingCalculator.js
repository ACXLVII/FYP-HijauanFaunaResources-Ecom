...
export default function PricingCalculator({
  ...
  // Use first price group (boulder_rocks only has one price group)
  ...
  const sizeType = selectedGroup.sizeType || 'unit';
  ...
  const handleAddToCart = () => {
    ...
    const getImageSrc = (imageData) => {
      if (!imageData) return '/images/shop/rocks.jpg';
    ...
    const imageString = images && images[0] ? getImageSrc(images[0]) : '/images/shop/rocks.jpg';
