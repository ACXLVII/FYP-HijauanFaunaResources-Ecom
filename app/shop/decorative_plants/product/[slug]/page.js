...
import Heading from '@/app/shop/decorative_plants/product/[slug]/components/sectionHeading'
import Content from '@/app/shop/decorative_plants/product/[slug]/components/sectionContent'
...
export default async function ProductPage({ params }) {
  ...
  const res = await fetch(`${protocol}://${host}/api/decorative_plants/${slug}`, { 
