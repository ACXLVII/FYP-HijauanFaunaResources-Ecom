...
import Heading from '@/app/shop/produce_plants/product/[slug]/components/sectionHeading'
import Content from '@/app/shop/produce_plants/product/[slug]/components/sectionContent'
...
export default async function ProductPage({ params }) {
  ...
  const res = await fetch(`${protocol}://${host}/api/produce_plants/${slug}`, { 
